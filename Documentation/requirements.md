...
**Technical Priority : (5/5)** Πρέπει να έρχονται τα σωστά δεδομένα απο την βάση με τους χρήστες της πλατφόρμας καθώς και τα αντίστοιχα τους δικαιώματα στην πλατφόρμα.
...
**Technical Priority : (5/5)** Διασφαλίζεται η χρήση της υπηρεσίας από μη διαπιστευμένους χρήστες. 
...
**Technical Priority : (5/5)** Είναι σημαντικο να διασφαλίζονται τα δεδομένα του χρήστη μετά από το πέρας χρήσης της πλατφόρμας.
