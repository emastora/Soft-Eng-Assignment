...
### ΛΑ-40
Ο χρήστης πάροχος χώρου πρέπει να μπορεί να δηλώνει την μέγιστη χωρητικότητα σε άτομα που μπορεί να υποστηρίξει ο χώρος (Set Max Attendants)

**Περιγραφή**

Ο χρήστης πάροχος χώρου πρέπει να μπορεί να δηλώνει μέχρι πόσα άτομα μπορούν να συμμετέχουν σε μια εκδήλωση στο χώρο του και σε περίπτωση που ξεπεραστεί ο αριθμός αυτός στις αγορές εισιτηρίων να γίνονται και οι αντίστοιχες ενέργειες.
...
### ΛΑ-40
Ο χρήστης πρέπει να μπορεί να στέλνει προσωπικά μηνύματα σε άλλο χρήστη (Send private messages)

**Περιγραφή**

Ο χρήστης πρέπει να μπορεί να στέλνει ιδιωτικά μηνύματα σε άλλους χρήστες, είτε φίλους του, είτε παρόχους χώρου κλπ για να συνεννοείται και να λαμβάνει έξτρα πληροφορίες σχετικά με τις εκδηλώσεις.
...
**Technical Difficulty : (5/5)** Η λειτουργία αυτή μπορεί να είναι συνηθισμένη όμως εμπεριέχει αρκετή πολυπλοκότητα βάση της οποίας είναι να διασφαλίζεται και η ασφάλεια των μηνυμάτων μεταξύ άλλων ενώ προφανώς είναι πολύ σημαντική και η αμεσότητα της λειτουργίας.
