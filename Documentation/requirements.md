...
**User Priority : (5/5)** Από τις σπουδαιότερες λειτουργίες της εφαρμογής καθώς ο χρήστης πρέπει να μπορεί να προσθέτει ΄΄αλλους χρήστες σαν φίλους. 
**Technical Difficulty : (5/5)** Απαιτητική εφαρμογή αν και αποτελεί μια διαδικασία έρευνας και αυτό γιατί όσο περισσότερα αόριστα κριτήρια βάζει ο χρήστης προς αναζήτηση (για παράδειγμα ένα είδος) θα πρέπει το σύστημα από μόνο του να του προσδώσει όσο το δυνατόν πιο φυσιολογικά στον χρήστη αποτελέσματα εκτιμώντας και άλλα κριτήρια (για παράδειγμα η τοποθεσία)
...
Ο χρήστης της πλατφόρμας πρέπει να μπορεί να ακολουθεί συγκεκριμένους χώρους που επιθυμεί έτσι ώστε να ενημερώνεται με ειδοποιήσεις ή όχι για τις εκδηλώσεις που γίνονται σε αυτούς. 
