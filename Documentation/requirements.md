...
**Technical Difficulty : (4/5)** Η συγκεκριμένη λειτουργία πρέπει να υποστηρίζεται από το σύστημα και τα δεδομένα κατα την δημιουργία μίας προσωπικής εκδήλωσης να αποθηκεύοντα σωστα. 
