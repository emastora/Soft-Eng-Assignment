...
**Technical Difficulty : (5/5)** Το σύστημα πρέπει να ανταποκρίνεται σε οποιαδήποτε αλλαγή και να ενημερώνει τα δεδομένα μια εκδήλωσης σωστά μετα από μία αλλαγή.
...
**Technical Difficulty : (/5)** Το σύστημα πρέπει να παρέχει την δυνατότητα διαγραφής των σωστών δεδομένων απο την βάση κατα την διαγραφή μάς δήμοσιας εκδήλωσης από τον χρήστη διοργανωτή που την δημιούργησε.
...
**Technical Difficulty : (5/5)** Το σύστημα πρέπει να αποθηκεύει σωστά στην βάση όλους τους χρήστες που έχουνε δηλώσει ότι θα παρεβρεθούν σε κάποια εκδήλωση και να τους ενημερώνει για τυχόν αλλαγές στην εκδήλωση.
...
**User Priority : (5/5)** Πολύ σημαντική λειτουργία για τον χρήστη πάροχο χώρου που πρέπει να καταχωρήσει τον χώρο του στην πλατφόρμα
...
**Technical Priority : (5/5)** Το σύστημα πρέπει να προτείνει τις σωστές εκδηλώσεις στον χρήστη με βάση τις προσωπικές του επιλογές.
